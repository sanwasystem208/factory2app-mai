...
export default {
    ...
    methods: {
       ...
       //   e.value.ornerid = this.selectedRows[0]._id;
        ...
        //    if (params.value == 0) {
        //      ret = '<h5 class="m-1"><span class="badge badge-dark pt-2 pb-2 badgewidth80">' + newLines[0].text + '</span></h5>'; 
        //    } else {
              ret = '<h5 class="m-1"><span class="badge badge-' + newLines[0].color + ' pt-2 pb-2 badgewidth80">' + newLines[0].text + '</span></h5>'; 
        //    }   
          } else {
              ret = '';     
          }  
        ...
        ageCellRenderer_importance(params) {
          ...
          if (newLines.length > 0) {
            if (params.value == 0) {
              ret = '<h5 class="m-1"><span class="badge badge-dark pt-2 pb-2 badgewidth70">' + newLines[0].text + '</span></h5>'; 
            } else {
        ...
        this.columnDefs = [
           ...
           }, 
           {
                ...
                cellStyle: function(params) {
                    return {'font-size': '14px', 'text-align': 'left', padding: 4 };
                }
           },  
           {
                headerName: '号機', 
                ...
                width: 70,
                cellStyle: function(params) {
                    return {'font-size': '16px', 'text-align': 'left', padding: 4 };
                }
            },         
            {
                headerName: '製品名', 
                ...
                width: 210,
                cellStyle: function(params) {
                    return {'font-size': '14px', 'text-align': 'left', 'vertical-align': 'middle', padding: 10 };
                }
            }, 
            {
                headerName: '状態',
                ...
                cellClass: "grid-cell",
                width: 100,
                cellRenderer: this.ageCellRenderer_status,
                cellStyle: function(params){
                    return {'font-size': '18px', 'text-align': 'center', padding: 1 };
                }
            },
            {
                headerName: '予定',
                ...
                cellClass: "grid-cell",
                width: 90,
                cellRenderer: this.ageCellRenderer_importance,
                cellStyle: function(params){
                    return {'font-size': '18px', 'text-align': 'center', padding: 1 };
                }
            }
